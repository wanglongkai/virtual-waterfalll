<template>
  <div class="app">
    <div class="container" ref="fContainerRef">
      <BookVirtualWaterfall :request="getData" :gap="15" :page-size="20" :column="column" :enter-size="column * 2">
...
import BookVirtualWaterfall from "./components/BookVirtualWaterfall.vue";
